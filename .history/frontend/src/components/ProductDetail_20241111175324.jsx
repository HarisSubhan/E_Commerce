...
const ProductDetail = () => {
  ...
  const [itemCount, setItemCount] = useState(
    parseInt(localStorage.getItem("itemCount")) || 0 // Retrieve itemCount from localStorage
  );
  ...
  useEffect(() => {
    localStorage.setItem("itemCount", itemCount); // Store itemCount in localStorage whenever it changes
  }, [itemCount]);
  ...
  const handleAddToCart = () => {
    if (product) {
      ...
      console.log("Product with formatted price:", productWithNumberPrice);
