...
const AdminAddProduct = () => {
  ...
  const uploadImage = async () => {
    ...
    data.append("upload_preset", "bpvhxghb"); // Replace with your Cloudinary preset
    try {
      ...
      setImageLoading(false);
      toast.error("Failed to upload image due to network issue"); // Display user-friendly error message
