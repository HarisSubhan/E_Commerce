...
const initialState = {
  ...
  deleteSuccess: false,
  deleteError: false,
  getSingleProductByIDLoading: false,
  getSingleProductByIDSuccess: false,
  getSingleProductByIDError: false,
};
...
export const productSlice = createSlice({
  ...
  reducers: {
    productReset: (state) => {
      ...
      state.getSingleProductByIDLoading = false;
      state.getSingleProductByIDError = false;
      state.getSingleProductByIDSuccess = false;
    },
  },
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getSingleProductByID.pending, (state) => {
        state.getSingleProductByIDLoading = true;
      })
      .addCase(getSingleProductByID.fulfilled, (state, action) => {
        state.getSingleProductByIDSuccess = true;
        state.product = action.payload; // Here, `action.payload` may be an object, not an array
      })
      .addCase(getSingleProductByID.rejected, (state, action) => {
        state.getSingleProductByIDError = true;
