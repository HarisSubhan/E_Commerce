...
const ProductDetail = () => {
  return (
    <>
      <HomePageHeader />
      <NavBar />
      <div className="container p-4">  {/* Wrap content in a container */}
        <Card className="p-3 mt-3">
          <div>Title</div>
          <hr />
          <div className="d-flex flex-wrap justify-content-between align-items-center"> {/* Use flex-wrap for responsiveness */}
            <div className="d-flex flex-column align-items-center">
              <img
                src="https://mannatthemes.com/robotech/default/assets/images/products/02.png"
                alt=""
                style={{ height: "auto", width: "100%" }}  {/* Use auto height and full width */}
              />
            </div>
            <div className="flex-grow-1"> {/* Allow text content to grow */}
        ...
        <div className="d-flex flex-wrap gap-3 mt-4"> {/* Use flex-wrap for responsive layout of tabs */}
          <h3>Description</h3>
