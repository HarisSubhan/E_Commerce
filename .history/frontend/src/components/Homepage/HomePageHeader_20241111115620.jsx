  ...
  const cartItems = [
    {
      id: 1,
      name: "Robotech Shoes",
      description: "New Colorful Shoes",
      price: 36.0,
    },
    {
      id: 2,
      name: "Robotech Camera",
      description: "White Table Camera",
      price: 36.0,
    },
  ];
          ...
          <Badge color="primary">
            ...
            >
              ...
              <Button
                ...
                fullWidth
                sx={{ mt: 2 }}
                onClick={handleClose} // You might want to replace this with a redirect or checkout function
              >
                Place Order
              </Button>
            </Menu>
